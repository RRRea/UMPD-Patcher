...
def download_and_decompile(base_apk_dlink: str, split_apk_dlink: str):
    ...
    """
    print("⬇️ Downloading and decompiling APKs...")
...
def recompile_and_sign(base_folder: str, split_folder: str, output_dir: str):
    """
    Recompiles and signs the modified APKs.
    """
    ...
    run_command(["java", "-jar", "uber-apk-signer.jar", "--apks", base_out_path], "Failed to sign base APK")
    run_command(["java", "-jar", "uber-apk-signer.jar", "--apks", split_out_path], "Failed to sign split APK")
...
def finalize_apks(directory: str):
    ...
    signed_base = os.path.join(directory, "base_recompiled-aligned-debugSigned.apk")
    signed_split = os.path.join(directory, "split_recompiled-aligned-debugSigned.apk")
...
def main():
    ...
    try:
        ...
        recompile_and_sign(base_decompile_dir, split_decompile_dir, ".")
        finalize_apks(".")
